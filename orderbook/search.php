				...
				<p class="text-secondary"> choose any one of the below<p>
					...
					if(isset($_POST['srch']))
					{
						if(!empty($_POST['name']))
						{
							...
							$sql2="SELECT * from boards where name like '$nm%'";
						...
						else if(!empty($_POST['place']))
						{
							...
							$sql2="SELECT * from boards where place like '$plc%'";
						...
						else if(!empty($_POST['model']))
						{
							...
							$sql2="SELECT * from boardk where model like '$mod%'";
						...
						else if(!empty($_POST['kg']))
						{
							...
							$sql2="SELECT * from boards where weight like '$kg%'";
